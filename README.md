# 🤖 AI & Computer Vision Engineer | Deep Learning Specialist | Explainable & Production-Ready AI

📍 Islamabad, Pakistan  
🔭 Open to **AI/ML Engineer roles**, **Computer Vision positions**, **research collaborations**, **internships**, **freelance contracts**, **remote opportunities**, and **MS/PhD programs**  
🚀 Gold Medalist (CGPA 4.0/4.0) • 1st Place Final Year Project 2025 • 10+ peer-reviewed publications (6+ published, 4+ in review/in progress)
...
- Explainability: Grad-CAM, attention mechanisms, interpretable feature analysis  
...
- Robust pipelines for large-scale datasets (10K–100K+ images)  
- Tools: **OpenCV**, NumPy, Pandas, scikit-learn  

**Versatile across domains**: medical diagnostics, precision agriculture, autonomous navigation, industrial quality inspection, surveillance/anomaly detection, retail analytics, AR/VR overlays, and any vision-based challenge.
...
- **Research Assistant** @ NeuralBioScan Lab, Riphah International University (Sept 2024 – Jan 2026)  
  Designed & trained computer vision models using transfer learning & custom fusion architectures; full lifecycle from data preparation to publication  
- **Data Science Intern** @ Code Alpha (Aug–Sep 2024)  
  Built predictive models (regression, LSTM), performed EDA, feature engineering, and performance evaluation  
- **Teaching Assistant** @ Riphah International University (Sept 2023 – June 2024)  
  Led labs in Data Structures & C++; mentored students on algorithms, problem-solving, and debugging  
...
<!-- Uncomment for extra polish once you add your username -->
